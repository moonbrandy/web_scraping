...
OUTPUT_PATH = "D:\\web_scraping\\raw_selenium_scraper\\output_%s.csv" % time.strftime("%Y_%m_%d_%H")
URLS_OUTPUT_PATH = "D:\\web_scraping\\raw_selenium_scraper\\urls_%s.csv" % time.strftime("%Y_%m_%d_%H")
# TEST_PATH = "test_%s.csv" % time.strftime("%Y_%m_%d_%H")
FAST_PATH = "D:\\web_scraping\\raw_selenium_scraper\\fast_%s.csv" % time.strftime("%Y_%m_%d_%H")
